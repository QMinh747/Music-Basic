...
import com.example.music.databinding.ListItemRecyclerRowBinding;
import com.example.music.models.DataModel;
public class MostlyPlayedListAdapter extends RecyclerView.Adapter<MostlyPlayedListAdapter.MyViewHolder> {

    private final List<String> songIdList;

    public MostlyPlayedListAdapter(List<String> songIdList) {
